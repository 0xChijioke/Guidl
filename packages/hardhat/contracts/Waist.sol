...
contract Waist is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Waist", "WAIST") {}
  ...
  function tokenURI(uint256 id) public view override returns (string memory) {
      ...
      string memory name = string(abi.encodePacked('#', id.toString(), ' Waist'));
      string memory description = string(abi.encodePacked('The protection from blows below the belt.'));
